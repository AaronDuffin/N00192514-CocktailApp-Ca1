...
import com.example.cocktailsapps.databinding.FragmentMainBinding

/**
 * A simple [Fragment] subclass as the default destination in the navigation.
 */
class MainFragment : Fragment(),
    CocktailListAdapter.ListItemListener{
    ...
    override fun onCreateView(
        ...
        viewModel.plants.observe(viewLifecycleOwner, Observer {
            adapter = CocktailListAdapter(it, this@MainFragment)
    ...
    override fun onItemClick(drink: CocktailEntity) {
        ...
        // Log.i(TAG, "onItemClick : Received Cocktail name ${drink.strDrink}")
        val action = MainFragmentDirections.actionMainFragmentToEditorFragment(drink)
